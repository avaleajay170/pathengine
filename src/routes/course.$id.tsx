        ...
        <aside className="space-y-6 lg:sticky lg:top-20 lg:self-start">
          ...
          <div className="surface-card p-6">
            ...
            <Button
              ...
              size="lg"
              onClick={() =>
                toast.success(isCompleted ? "Opening course" : "Enrolled", {
                  description: isCompleted
                    ? `Resuming ${course.title}.`
                    : `${course.title} is now the active node in your roadmap.`,
                })
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                toast("Added to your path", {
                  description: `Lumi re-sequenced the remaining stages around ${course.hours} extra hours.`,
                })
              }
            >
              Add to my path
